...
- **Stephan Wojciekowski**. Author, maintainer.

- **Lars Andersen**. Author.

- **Jonas Schick**. Contributor.

- **Sebastian Bossert**. Author.

## Citation

Source:
[`inst/CITATION`](https://github.com/Boehringer-Ingelheim/BayesianMCPMod/blob/1.3.2/inst/CITATION)
