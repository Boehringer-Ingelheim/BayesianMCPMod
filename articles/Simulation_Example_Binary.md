...
- In
  ...
  `probability_scale = TRUE`.
- It is possible to specify a specific contrast matrix (that is then
...
```
    ...
    ##    Significance Freq: 0.92 0.90 0.92 0.89 0.73 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.88 
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.98 0.98 0.98 0.97 0.73 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.92 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.96 0.94 0.96 0.95 0.78 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.92 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.92 0.92 0.92 0.97 0.52 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.88 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.80 0.67 0.80 0.64 0.92 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.87 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.27 0.29 0.17 0.14 
    ##   MED not reached Freq:        0.07 
...
Another specification that can affect the success probabilities is the
choice of contrast used for the evaluation. In Liu et al. (2022), it is
shown that contrasts based on the number of patients in each dose group
exhibit robust performance and good operating characteristics. This
...
```
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.95 0.94 0.95 0.94 0.77 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.87 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.01 0.01 0.11 0.74 
    ##   MED not reached Freq:        0.09 
    ##   No success in MCP step Freq: 0.04 
    ## 
    ## $sigEmax
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.95 0.94 0.95 0.94 0.79 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.91 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.00 0.00 0.12 0.79 
    ##   MED not reached Freq:        0.05 
    ##   No success in MCP step Freq: 0.04 
    ## 
    ## $logistic
    ## Bayesian Multiple Comparison Procedure
    ##   Estimated Success Rate: 0.95 
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.92 0.89 0.93 0.89 0.73 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.84 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.00 0.00 0.08 0.76 
    ##   MED not reached Freq:        0.11 
    ##   No success in MCP step Freq: 0.05 
    ## 
    ## $exponential
    ## Bayesian Multiple Comparison Procedure
    ##   Estimated Success Rate: 0.97 
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.95 0.92 0.95 0.95 0.64 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.89 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.00 0.00 0.01 0.88 
    ##   MED not reached Freq:        0.08 
    ##   No success in MCP step Freq: 0.03 
    ## 
    ## $emax
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.73 0.56 0.73 0.56 0.92 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.89 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.25 0.31 0.21 0.12 
    ##   MED not reached Freq:        0.03 
...
```
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.95 0.95 0.94 0.93 0.86 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.88 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.00 0.02 0.10 0.76 
    ...
    ##   N Simulations:          100 
    ##    Model Shape:        lin sigE  log  exp emax 
    ##    Significance Freq: 0.88 0.78 0.88 0.76 0.96 
    ## MED Assessment on Probability Scale
    ##   Selection Method:            avgFit 
    ##   MED reached Freq:            0.92 
    ##    Dose Level:  2.5  5.0 10.0 20.0 
    ##    MED Freq:   0.14 0.29 0.22 0.27 
