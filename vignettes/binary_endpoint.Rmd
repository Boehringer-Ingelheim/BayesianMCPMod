...
A contrast matrix is generated based on the number of patients per dose group, see @fleischer_2022 for more details. This choice is motivated by the assessments reported in @liu2022commentaryanalyzingbinarydata, which demonstrate that this type of contrast is robust and provides good statistical power across a broad range of potential outcome scenarios.
Please note that also other options would be possible, e.g. using weight based on the observed variability.
