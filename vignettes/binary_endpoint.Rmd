...
In a last step we are robustifying this prior on the logit scale. This step should come before, see other code.
...
models <- Mods(
  ...
  emax = 10,
  doses = dose_levels,
  placEff = RBesT::logit(0.1),
  maxEff = RBesT::logit(0.3) - RBesT::logit(0.1)
)
