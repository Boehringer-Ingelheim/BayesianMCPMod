...
# bar_data_min <- data.table(
  Bay_linear = minimal_nsample_Bay$result_table$linear,
  Bay_exp = minimal_nsample_Bay$result_table$exponential,
  Bay_emax = minimal_nsample_Bay$result_table$emax,
  diff_linear = results_min_nsample$linear,
  diff_exp = results_min_nsample$exponential,
  diff_emax = results_min_nsample$emax
)
