...
results_nsim_var <- data.table(
  ...
  Bay_sigemax = results_nsim_Bay_var$Bay_sigEmax,
  Bay_logistic = results_nsim_Bay_var$Bay_logistic
)
...
results_nsim_diff_var <- data.table(
  ...
  sigemax = results_nsim_var$Bay_sigemax - results_nsim_var$MCP_sigemax,
  logistic = results_nsim_var$Bay_logistic - results_nsim_var$MCP_logistic,
  n_sim = n_sim_values
  )
