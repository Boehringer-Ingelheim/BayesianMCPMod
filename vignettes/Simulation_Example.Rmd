...
As in [the analysis example vignette](analysis_normal.Rmd) we focus on the indication MDD and make use of historical data that is included in the clinDR package. 
...
We will make use of the same getPriorList function as in the [analysis example vignette](analysis_normal.Rmd) to create a MAP prior.
