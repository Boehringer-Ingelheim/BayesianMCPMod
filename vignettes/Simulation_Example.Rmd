...
A more general overview of the R package was provided with a [poster](https://github.com/Boehringer-Ingelheim/BayesianMCPMod/blob/f942d941cb9fc1c457717b71dd07363f0a7b8966/inst/PSI_Poster_2024.pdf) presented during the PSI 2024 Conference.
...
If both the arguments `delta` and `evidence_level` are provided, a Bayesian decision rule for the MED of the form
...
Thus, using the  is only recommended when using parallel computing.
```{r}
