...
data <- data.table(
  ...
  plot_max_eff <- ggplot(data = data)+
    ...
    labs(title = "Power for different models and differen exptected effects for maximum dose")+
    theme_bw()
...
plot_minimal <- plot_power_deviation(results_min_max_eff, results_min_max_eff$expectedEffect, "assumed maximum effect", c(0.05,0.1,0.2,0.3,0.5))
plot_minimal
```
...
plot_monotonic <- plot_power_deviation(results_monotonic_max_eff, results_monotonic_max_eff$expectedEffect, "assumed maximum effect", c(0.05,0.1,0.2,0.3,0.5))
plot_monotonic
```
...
plot_var <- plot_power_deviation(results_var_max_eff, results_var_max_eff$expectedEffect, "assumed maximum effect", c(0.05,0.1,0.2,0.3,0.5))
plot_var
```
...
plot_nsim <- plot_power_deviation(results_nsim_diff, results_nsim_diff$n_sim, "nsim", c(100, 500, 1000, 2500, 5000))
plot_nsim
```
...
plot_nsim_monotonic <-  plot_power_deviation(results_nsim_diff_monotonic, results_nsim_diff_monotonic$n_sim, "nsim", c(100, 500, 1000, 2500, 5000))
plot_nsim_monotonic
```
...
plot_nsim_non_monotonic <-  plot_power_deviation(results_nsim_diff_non_monotonic, results_nsim_diff_non_monotonic$n_sim, "nsim", c(100, 500, 1000, 2500, 5000))
...
plot_nsim_var <-  plot_power_deviation(results_nsim_diff_var, results_nsim_diff_var$n_sim, "nsim", c(100, 500, 1000, 2500, 5000))
plot_nsim_var
```
